...
const Header: React.FC = () => {
  ...
  return (
    <header>
      <div
        className={`bg-bglight dark:bg-bgdark z-30 top-0 drop-shadow-md fixed transition-transform duration-400 px-4 h-16 w-full flex items-center justify-between ${navClassList.join(
          " "
        )}`}
      >
        <Link href="/">
      ...
      <nav className="fixed bottom-4 z-30 left-1/2 transform -translate-x-1/2 bg-bglight dark:bg-carddark dark:text-textlight w-11/12 rounded drop-shadow-lg">
