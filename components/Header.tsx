    ...
    <header className="md:flex">
      ...
      >
        <div className="w-full h-full mx-auto max-w-6xl flex items-center justify-between">
          <Link href="/">
            <a className="text-xl sm:text-2xl">
              SatNaing
          ...
          <div className="flex">
              ...
              <ul className="flex">
                {navLinks.map((navLink) => (
                  <li key={navLink.url}>
                    <a
                      href={navLink.url}
                      className="text-lg flex flex-col items-center mr-6"
                    >
                      {navLink.text}
                    </a>
                  </li>
            ...
            >
              <svg
                ...
                width="24"
                height="24"
                className="fill-textlight hidden dark:inline-block transform scale-110"
              >
              ...
              <svg
                ...
                width="24"
                height="24"
                className="dark:hidden transform scale-90"
              >
